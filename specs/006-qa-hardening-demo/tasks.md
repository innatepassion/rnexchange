...
- [ ] T061 [P] Update `specs/006-qa-hardening-demo/quickstart.md` with final demo script steps that reflect the implemented UI and automated tests, including a recommended “day in the life” script for `trader_demo`, `broker_demo`, and `exchange_demo`
...
- [ ] T066 [P] Run timed “day in the life” demo dry-runs using the updated quickstart script (login as `trader_demo`, `broker_demo`, and `exchange_demo` to place a trade, adjust funds, run EOD, and open statements) and record completion times and any blocking usability issues in `specs/006-qa-hardening-demo/research.md`; iterate PC-001–PC-00N and associated fixes until SC-004 (“no blocking usability issues” and <15-minute completion) is satisfied
