...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRADERPROFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRADERPROFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRADERPROFILE actions', async () => {
      const arg = { id: 18030 };
    ...
    it('dispatches UPDATE_TRADERPROFILE actions', async () => {
      const arg = { id: 18030 };
    ...
    it('dispatches PARTIAL_UPDATE_TRADERPROFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRADERPROFILE actions', async () => {
      const arg = 42666;
