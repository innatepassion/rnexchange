...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './execution.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXECUTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXECUTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXECUTION actions', async () => {
      const arg = { id: 19561 };
    ...
    it('dispatches UPDATE_EXECUTION actions', async () => {
      const arg = { id: 19561 };
    ...
    it('dispatches PARTIAL_UPDATE_EXECUTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXECUTION actions', async () => {
      const arg = 42666;
