...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './exchange.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXCHANGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXCHANGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXCHANGE actions', async () => {
      const arg = { id: 2368 };
    ...
    it('dispatches UPDATE_EXCHANGE actions', async () => {
      const arg = { id: 2368 };
    ...
    it('dispatches PARTIAL_UPDATE_EXCHANGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXCHANGE actions', async () => {
      const arg = 42666;
