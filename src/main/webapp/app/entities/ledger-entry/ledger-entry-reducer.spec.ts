...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEDGERENTRY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEDGERENTRY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEDGERENTRY actions', async () => {
      const arg = { id: 14814 };
    ...
    it('dispatches UPDATE_LEDGERENTRY actions', async () => {
      const arg = { id: 14814 };
    ...
    it('dispatches PARTIAL_UPDATE_LEDGERENTRY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEDGERENTRY actions', async () => {
      const arg = 42666;
