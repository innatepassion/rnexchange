...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RISKALERT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RISKALERT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RISKALERT actions', async () => {
      const arg = { id: 6305 };
    ...
    it('dispatches UPDATE_RISKALERT actions', async () => {
      const arg = { id: 6305 };
    ...
    it('dispatches PARTIAL_UPDATE_RISKALERT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RISKALERT actions', async () => {
      const arg = 42666;
