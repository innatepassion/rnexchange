...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BROKERDESK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BROKERDESK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BROKERDESK actions', async () => {
      const arg = { id: 5188 };
    ...
    it('dispatches UPDATE_BROKERDESK actions', async () => {
      const arg = { id: 5188 };
    ...
    it('dispatches PARTIAL_UPDATE_BROKERDESK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BROKERDESK actions', async () => {
      const arg = 42666;
