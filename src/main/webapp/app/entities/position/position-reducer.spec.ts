...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './position.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSITION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POSITION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POSITION actions', async () => {
      const arg = { id: 21947 };
    ...
    it('dispatches UPDATE_POSITION actions', async () => {
      const arg = { id: 21947 };
    ...
    it('dispatches PARTIAL_UPDATE_POSITION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POSITION actions', async () => {
      const arg = 42666;
