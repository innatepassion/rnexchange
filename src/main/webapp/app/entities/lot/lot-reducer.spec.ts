...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './lot.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOT actions', async () => {
      const arg = { id: 5166 };
    ...
    it('dispatches UPDATE_LOT actions', async () => {
      const arg = { id: 5166 };
    ...
    it('dispatches PARTIAL_UPDATE_LOT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOT actions', async () => {
      const arg = 42666;
