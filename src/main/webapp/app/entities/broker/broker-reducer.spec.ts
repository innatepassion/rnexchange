...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './broker.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BROKER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BROKER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BROKER actions', async () => {
      const arg = { id: 32499 };
    ...
    it('dispatches UPDATE_BROKER actions', async () => {
      const arg = { id: 32499 };
    ...
    it('dispatches PARTIAL_UPDATE_BROKER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BROKER actions', async () => {
      const arg = 42666;
