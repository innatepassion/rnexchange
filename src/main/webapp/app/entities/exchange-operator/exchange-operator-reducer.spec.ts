...
import reducer, {
  ...
  reset,
  updateEntity,
} from './exchange-operator.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXCHANGEOPERATOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXCHANGEOPERATOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXCHANGEOPERATOR actions', async () => {
      const arg = { id: 21217 };
    ...
    it('dispatches UPDATE_EXCHANGEOPERATOR actions', async () => {
      const arg = { id: 21217 };
    ...
    it('dispatches PARTIAL_UPDATE_EXCHANGEOPERATOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXCHANGEOPERATOR actions', async () => {
      const arg = 42666;
