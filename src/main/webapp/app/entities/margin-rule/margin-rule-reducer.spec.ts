...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARGINRULE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MARGINRULE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MARGINRULE actions', async () => {
      const arg = { id: 25255 };
    ...
    it('dispatches UPDATE_MARGINRULE actions', async () => {
      const arg = { id: 25255 };
    ...
    it('dispatches PARTIAL_UPDATE_MARGINRULE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MARGINRULE actions', async () => {
      const arg = 42666;
