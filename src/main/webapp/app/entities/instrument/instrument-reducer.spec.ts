...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTRUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_INSTRUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_INSTRUMENT actions', async () => {
      const arg = { id: 16806 };
    ...
    it('dispatches UPDATE_INSTRUMENT actions', async () => {
      const arg = { id: 16806 };
    ...
    it('dispatches PARTIAL_UPDATE_INSTRUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_INSTRUMENT actions', async () => {
      const arg = 42666;
