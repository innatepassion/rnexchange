...
import reducer, {
  ...
  reset,
  updateEntity,
} from './daily-settlement-price.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DAILYSETTLEMENTPRICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DAILYSETTLEMENTPRICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DAILYSETTLEMENTPRICE actions', async () => {
      const arg = { id: 12392 };
    ...
    it('dispatches UPDATE_DAILYSETTLEMENTPRICE actions', async () => {
      const arg = { id: 12392 };
    ...
    it('dispatches PARTIAL_UPDATE_DAILYSETTLEMENTPRICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DAILYSETTLEMENTPRICE actions', async () => {
      const arg = 42666;
