...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SETTLEMENTBATCH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SETTLEMENTBATCH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SETTLEMENTBATCH actions', async () => {
      const arg = { id: 30023 };
    ...
    it('dispatches UPDATE_SETTLEMENTBATCH actions', async () => {
      const arg = { id: 30023 };
    ...
    it('dispatches PARTIAL_UPDATE_SETTLEMENTBATCH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SETTLEMENTBATCH actions', async () => {
      const arg = 42666;
