...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MARKETHOLIDAY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MARKETHOLIDAY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MARKETHOLIDAY actions', async () => {
      const arg = { id: 31234 };
    ...
    it('dispatches UPDATE_MARKETHOLIDAY actions', async () => {
      const arg = { id: 31234 };
    ...
    it('dispatches PARTIAL_UPDATE_MARKETHOLIDAY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MARKETHOLIDAY actions', async () => {
      const arg = 42666;
