...
import { deleteEntity, getEntity } from './contract.reducer';
...
export const ContractDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="rnexchangeApp.contract.delete.question">
        <Translate contentKey="rnexchangeApp.contract.delete.question" interpolate={{ id: contractEntity.id }}>
