...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRADINGACCOUNT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRADINGACCOUNT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRADINGACCOUNT actions', async () => {
      const arg = { id: 30699 };
    ...
    it('dispatches UPDATE_TRADINGACCOUNT actions', async () => {
      const arg = { id: 30699 };
    ...
    it('dispatches PARTIAL_UPDATE_TRADINGACCOUNT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRADINGACCOUNT actions', async () => {
      const arg = 42666;
