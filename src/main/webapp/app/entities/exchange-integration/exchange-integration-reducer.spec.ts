...
import reducer, {
  ...
  reset,
  updateEntity,
} from './exchange-integration.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXCHANGEINTEGRATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXCHANGEINTEGRATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXCHANGEINTEGRATION actions', async () => {
      const arg = { id: 5396 };
    ...
    it('dispatches UPDATE_EXCHANGEINTEGRATION actions', async () => {
      const arg = { id: 5396 };
    ...
    it('dispatches PARTIAL_UPDATE_EXCHANGEINTEGRATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXCHANGEINTEGRATION actions', async () => {
      const arg = 42666;
