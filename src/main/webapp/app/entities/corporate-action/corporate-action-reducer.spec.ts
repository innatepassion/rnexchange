...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CORPORATEACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CORPORATEACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CORPORATEACTION actions', async () => {
      const arg = { id: 25082 };
    ...
    it('dispatches UPDATE_CORPORATEACTION actions', async () => {
      const arg = { id: 25082 };
    ...
    it('dispatches PARTIAL_UPDATE_CORPORATEACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CORPORATEACTION actions', async () => {
      const arg = 42666;
